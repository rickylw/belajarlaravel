...
<div class="form-group">
    <label for="mutasitujuan" class="col-sm-2 control-label">mutasitujuan</label>
    <div class="col-sm-10">
    <input type="text" name="mutasitujuan" class="form-control" value="{{ $mutasitujuan ?? '' }}" >
    </div>
</div>

<div class="form-group">
    <label for="deskripsimutasipegawai" class="col-sm-2 control-label">deskripsimutasipegawai</label>
    <div class="col-sm-10">
    <input type="text" name="deskripsimutasipegawai" class="form-control" value="{{ $deskripsimutasipegawai ?? '' }}" >
</div>
</div>
...
<div class="form-group">
    ...
    <a href="{{ route('mutasipegawai.index') }}" class="btn btn-primary" role="button">Batal</a>
</div>
</div>
