...
<div class="container">
    <div class="row">
        ...
        <div class="card-body">
            <form class="form-horizontal" action="{{ route('admin.pensiun-unitkerja.forward', $unitkerja->id) }}" method="post" enctype="multipart/form-data"> 
                {{ csrf_field() }}
                <div class="row">
                ...
                <div class="form-group">
                    ...
                    <a href="{{ route('admin.pensiun-unitkerja.index') }}" class="btn btn-primary" role="button">Batal</a>
                    </div>
                </div>
            </form>            
          </div>
