    ...
    <div class="row">
        ...
        <div class="card">
            <div class="card-header">
                <a class="btn btn-primary btn-md" href="{{ route('pegawai.resign.create') }}">
            ...
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0" style="table-layout: fixed">
                ...
                @forelse($resignPegawai as $item)
                    <tr>
                        ...
                        <td>
                            <div class="btn-group">
                                <a class="btn btn-success" href="{{ route('pegawai.resign.edit', $item->id) }}">
                                <i class="fas fa-pencil-alt"></i>
                                </a>
                                <a class="btn btn-danger" href="{{ route('pegawai.resign.delete', $item->id) }}">
