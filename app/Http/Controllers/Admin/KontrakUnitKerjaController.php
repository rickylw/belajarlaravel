...
class KontrakUnitKerjaController extends Controller
{
    public function index() {
        $unitkerja = DB::table('tbl_dataunitkerja')
                    ...
                    ->select(DB::raw('tbl_dataunitkerja.*, tbl_kontrak_unitkerja.lama_kontrak as lama_kontrak, tbl_kontrak_unitkerja.status as status_kontrak, tbl_kontrak_unitkerja.created_at as tanggal_pembuatan_kontrak'))
                    ->paginate(10);
